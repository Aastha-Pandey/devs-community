...
setDays(7);
  ...
  <div className="flex flex-col space-y-2">
  {
    ...
    <div className="text-left flex-col space-y-2 justify-start">
      <div className="text-gray-100  hover:text-indigo-500 text-2xl font-bold"> {post.title}</div>
      <div className="flex space-x-2"> {
          post.tag_list.map((tag, i) => <Link key = {i} href = "/">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" className="crayons-icon">
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a6hsif7p4m4f2z8m579jl0wxbgy8ojph" className=" crayons-icon reaction-icon not-reacted"><title id="a6hsif7p4m4f2z8m579jl0wxbgy8ojph">Comment button</title><path fill = "currentColor" d="M10.5 5h3a6 6 0 110 12v2.625c-3.75-1.5-9-3.75-9-8.625a6 6 0 016-6zM12 15.5h1.5a4.501 4.501 0 001.722-8.657A4.5 4.5 0 0013.5 6.5h-3A4.5 4.5 0 006 11c0 2.707 1.846 4.475 6 6.36V15.5z"></path></svg>
...
<button className="bg-gray-600 hover:bg-gray-500 hover:text-gray-300 px-4 py-2 text-sm text-gray-200 rounded-md">Save</button>
          </span>
