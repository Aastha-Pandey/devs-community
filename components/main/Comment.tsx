...
const Comment = ({ articleId, commentsCount }) => {
  ...
  return (
    <>
      <header className='bg-gray-800 font-bold text-xl text-gray-50 flex justify-between items-end'>
        <span>Discussion ({commentsCount})</span>
        <button className='text-sm font-semibold px-4 py-2 rounded-md ring-2 ring-gray-700'>
          Subscribe
        </button>
      </header>
